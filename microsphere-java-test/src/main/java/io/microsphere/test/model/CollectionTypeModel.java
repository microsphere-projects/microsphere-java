...
public class CollectionTypeModel {
    ...
    public Queue<PrimitiveTypeModel> getPrimitiveTypeModels() {
        return primitiveTypeModels;
    }

    public void setPrimitiveTypeModels(Queue<PrimitiveTypeModel> primitiveTypeModels) {
        this.primitiveTypeModels = primitiveTypeModels;
    }

    public Deque<Model> getModels() {
        return models;
    }

    public void setModels(Deque<Model> models) {
        this.models = models;
    }

    public Set<Model[]> getModelArrays() {
        return modelArrays;
    }

    public void setModelArrays(Set<Model[]> modelArrays) {
