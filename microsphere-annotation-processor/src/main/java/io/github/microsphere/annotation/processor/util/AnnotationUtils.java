...
import static io.github.microsphere.annotation.processor.util.TypeUtils.getType;
...
public interface AnnotationUtils {
    ...
    static List<AnnotationMirror> getAnnotations(AnnotatedConstruct annotatedConstruct,
        ...
        return getAnnotations(annotatedConstruct,
                annotation -> TypeUtils.isSameType(annotation.getAnnotationType(), annotationClassName));
    }
    ...
    static List<AnnotationMirror> getAllAnnotations(Element element, Predicate<AnnotationMirror>... annotationFilters) {
        ...
        List<AnnotationMirror> allAnnotations = TypeUtils.isTypeElement(element) ?
                TypeUtils.getHierarchicalTypes(TypeUtils.ofTypeElement(element))
                        .stream()
