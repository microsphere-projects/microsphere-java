 ...
 * @see ObjectToDoubleConverter
 * @since 1.0.0
 */
public class ObjectToDoubleConverterTest extends BaseConverterTest<Object, Double> {

    @Override
    protected AbstractConverter<Object, Double> createConverter() {
        return INSTANCE;
    }
