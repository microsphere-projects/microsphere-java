...
class DelegatingWrapperTest {
    ...
    void test() {
        ...
        assertTrue(wrapper.isWrapperFor(CharSequence.class));

        Object result = wrapper.unwrap(String.class);
        assertEquals(delegate, result);

        result = wrapper.unwrap(DelegatingWrapperImpl.class);
