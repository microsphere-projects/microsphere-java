 ...
 * @since 1.0.0
 */
public class ObjectToFloatConverter extends AbstractConverter<Object, Float> {

    /**
     * Singleton instance of {@link ObjectToFloatConverter}.
     */
    ...
    protected Float doConvert(Object source) {
        ...
        return convertIfPossible(source, Float.class);
    }
}
