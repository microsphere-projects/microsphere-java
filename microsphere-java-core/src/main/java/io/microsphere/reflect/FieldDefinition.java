...
public class FieldDefinition extends MemberDefinition {
     ...
     */
    public FieldDefinition(@Nonnull Version since, @Nonnull Class<?> declaredClass,
     ...
     * @param fieldName     the field name
     */
    public FieldDefinition(@Nonnull Version since, @Nullable Deprecation deprecation, @Nonnull Class<?> declaredClass,
                           @Nonnull String fieldName) {
