...
public abstract class TypeUtils implements Utils {
     ...
     * <h3>Example Usage</h3>
     * <pre>{@code
     * Type listType = new ArrayList<>().getClass().getGenericSuperclass(); // ParameterizedType for List<String>
     * Type superType = List.class;
     *
     * boolean assignable1 = TypeUtils.isAssignableFrom(superType, listType); // returns true
     *
     * Type mapType = new HashMap<>().getClass().getGenericSuperclass(); // ParameterizedType for AbstractMap<String, Integer>
     ...
     * Type targetType = new ArrayList<>().getClass().getGenericSuperclass(); // ParameterizedType for List<String>
     *
