 ...
 * @see ResourceConstants#CONFIGURATION_PROPERTY_METADATA_RESOURCE
...
public class MetadataResourceConfigurationPropertyLoader extends ClassPathResourceConfigurationPropertyLoader {
    ...
    public MetadataResourceConfigurationPropertyLoader() {
        super(CONFIGURATION_PROPERTY_METADATA_RESOURCE);
    }
