...
public class JSONArray {
    ...
    public JSONArray put(double value) throws JSONException {
        this.values.add(checkDouble(value));
        return this;
    }
    ...
    public double getDouble(int index) throws JSONException {
        ...
        if (result == null) {
            throw typeMismatch(index, object, "double");
        }
        return result;
    }
    ...
    public int getInt(int index) throws JSONException {
        ...
        if (result == null) {
            throw typeMismatch(index, object, "int");
        }
        return result;
    }
    ...
    public long getLong(int index) throws JSONException {
        ...
        if (result == null) {
            throw typeMismatch(index, object, "long");
        }
        return result;
    }
    ...
    public String getString(int index) throws JSONException {
        ...
        if (result == null) {
            throw typeMismatch(index, object, "String");
        }
        return result;
    }
    ...
    public JSONObject toJSONObject(JSONArray names) throws JSONException {
        int length = names == null ? 0 : min(names.length(), this.values.size());
        if (length == 0) {
            return null;
        }
